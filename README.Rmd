...
Defaults to refetching after 24 hours.
...
Note that `extra_subject` here is whatever subject you want to add to your email, normally as a way to tell those getting the email that it is a newlsetter email.
...
If you want to preview it (and you authorized `gmailr` with the correct scopes), then you can use `b2n_create_draft` to push it to your GMail account and preview the email that is in `draft_email`.
